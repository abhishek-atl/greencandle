...
<div class="container-fluid v-cloak">
    <div class="card">
        <div class="card-header mt-3 row justify-content-between">
            <h4 class="ml-4">Groups</h4>
            <a href="{{ route('admin.groups.add') }}" class="btn mr-3 btn-outline-primary">Add Group</a>
        </div>
                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        <tr v-for="(item, index) in items" :key="item.id">
                            ...
                            <td v-else>No</td>
                            <td>
                                <a :href="'{{ route("admin.groups.edit") }}/' + item.id" type="button" class="btn mb-1 btn-rounded btn-outline-primary btn-sm"><i class="fa fa-pencil"></i></a>
...
@push('pageScripts')
<script>
    let indexRoute = 'admin.groups.indexJson';
